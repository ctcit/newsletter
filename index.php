...
<html>
	...
	<body>
        ...
        <li><a class="link" href="../trips/api/AddTripsFromNewsletter.php" onclick="return confirm('Update trip signup system. Are you sure?')" target="_blank">Update trip signup system</a></li>
		<?php
